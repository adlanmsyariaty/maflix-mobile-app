...
class ControllerOfMovie {
    ...
    static async addMovie(req, res, next) {
        const t = await sequelize.transaction()
        try {
            const {title, synopsis, trailerUrl, imgUrl, rating, genres, casts, UserMongoId} = req.body
            console.log(title, synopsis, trailerUrl, imgUrl, rating, genres, casts, UserMongoId)
